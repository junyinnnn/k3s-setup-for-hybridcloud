...
NODE_ROLE="worker"  # Set to "master" or "worker"
HOSTNAME="k3s-worker-1"  # Set to "k3s-master" or "k3s-worker-<number>"
THIS_NODE_PUBLIC_IP="52.184.80.128"  # Public IP of this node
THIS_NODE_WG_IP="10.0.0.2"  # WireGuard IP for this node (e.g., 10.0.0.1 for master, 10.0.0.2 for worker 1, etc.)
THIS_NODE_WG_PRIVATE_KEY="AJ/4ZfAfda6MN5VTKWzKrtfz1OhV6fvQniqfs0lx1Uw="  # Generate with wg genkey
THIS_NODE_WG_PUBLIC_KEY="zsmwRNeUER/Tnao5UB3CsIrfrJ7BtMclq2RuvODfyi8="    # Derived from private key with wg pubkey
...
K3S_TOKEN="K10dddee81011fde8a00158db8c5ba093170c3dead464f0fd8096f790fb42c03828::server:3ccd6768f06483d7de7d9d51d4590ebf"  # Get from master after its K3s install (leave blank for master initially)
